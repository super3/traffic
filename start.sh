...
while true
do
        sh capture.sh "cam1" "http://traffic1.coronaca.gov/mjpg/video.mjpg?fps=15" $tm &
        sh capture.sh "cam2" "http://traffic2.coronaca.gov/mjpg/video.mjpg?fps=15" $tm &
        ...
        sh capture.sh "cam6" "http://traffic6.coronaca.gov/mjpg/video.mjpg?fps=15" $tm &
        sh capture.sh "cam7" "http://traffic7.coronaca.gov/mjpg/video.mjpg?fps=15" $tm &
